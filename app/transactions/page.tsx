        ...
        <main className="mx-auto max-w-7xl px-4 py-6 pb-6 sm:px-6 sm:py-8">
          <motion.section initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="mb-6 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <p className="text-sm font-bold uppercase tracking-[0.24em] text-[#8be9fd]">Ledger history</p>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-[#a7b0c8]">
                Dedicated audit view for debit and credit rows. Debit transactions expose an authenticated PDF receipt generated by the local Next.js API.
              </p>
            </div>
          ...
          <section className="mb-6 grid gap-4 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="game-panel rounded-xl p-5">
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#ff79c6]">Authenticated account</p>
              <h2 className="mt-3 text-2xl font-black text-white">{user?.name ?? "Loading user"}</h2>
              <p className="mt-2 text-sm text-[#a7b0c8]">{user?.email ?? "Fetching session..."}</p>
            ...
            <div className="glass-surface-2 rounded-xl p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-[#a7b0c8]">
                The table fetches PDFs through `GET /api/transactions/:id/receipt` using the Auth.js session. That keeps receipt access protected instead of exposing public static files.
              </p>
