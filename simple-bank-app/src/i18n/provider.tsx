...
import { dictionaries, type DictionaryKey, type Locale } from "@/i18n/dictionaries";
...
function detectLocale(): Locale {
  try {
    // expo-localization is optional; fall back gracefully
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const Localization = require("expo-localization") as { locale?: string };
    const lang = Localization.locale ?? "pt-BR";
